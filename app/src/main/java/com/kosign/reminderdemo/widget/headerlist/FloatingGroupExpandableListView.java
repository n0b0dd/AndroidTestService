package com.kosign.reminderdemo.widget.headerlist;
...
import com.kosign.reminderdemo.R;
...
public class FloatingGroupExpandableListView extends ExpandableListView {
	...
	private OnTouchFloatingGroupListener mOnTouchFloatingGroupListener;
...
//
	...
	public void setOnTouchFloatingGroupListener(OnTouchFloatingGroupListener listener) {
		mOnTouchFloatingGroupListener = listener;
	}
...
//                    mOnTouchFloatingGroupListener.onTouchGroupListener(mFloatingGroupPosition, !mCheckBox.isChecked());
//                    return false;
//                }
//            });
		}
	...
	private void drawDefaultSelector(Canvas canvas) {
		if(getFirstVisiblePosition() >= 0 && getFirstVisiblePosition() < getChildCount() && mSelectorRect != null && !mSelectorRect.isEmpty()) {
			final int floatingGroupFlatPosition = getFlatListPosition(getPackedPositionForGroup(mFloatingGroupPosition));
...
//		}
	...
	public interface OnTouchFloatingGroupListener {
		void onTouchGroupListener(int groupPosition, boolean groupChecked);
	}
}
